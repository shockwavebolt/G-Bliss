function Category({ imgSrc, category }) {
  return (
    <div
      className="flex flex-col p-[8px] border-2 border-white  gap-[24px] transition-colors duration-200 bg-white rounded-lg shadow-[0px_4px_4px_rgba(0,0,0,0.25)] xs:gap-[40px]
