function Category({ imgSrc, category }) {
  return (
    <div className="xs:gap-[40px] hover:border-orange00 group border-resin00 flex cursor-pointer flex-col gap-[24px] rounded-lg border-4 bg-white p-[8px] shadow-[0px_4px_4px_rgba(0,0,0,0.25)] transition-colors duration-200 hover:cursor-pointer md:gap-[32px] lg:p-[4px]">
      <img
