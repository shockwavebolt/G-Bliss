        ...
        {location.pathname !== "/checkout" ? (
          <>
            <Link
              ...
              className={`${
                toggleNavMenu
                  ? "cursor-pointer  tracking-wider text-[20px] transition-colors duration-200 ease-in-out logoShadow text-shadow-lg font-font02 hover:text-orange00"
                  : "hidden"
              }`}
            >
              G-Bliss
            ...
            <div className="flex  gap-[16px]">
              ...
              <div className="flex flex-col ">
                <div className="self-end hamburger-container">
                  <button
                    type="button"
