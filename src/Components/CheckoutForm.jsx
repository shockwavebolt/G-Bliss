...
function CheckoutForm() {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2">
      <div className="flex flex-col py-[64px] px-[48px]">
        <div className="flex flex-col gap-[48px]">
          <div className="flex flex-col gap-[24px]">
            <label className="flex items-center justify-between">
              <span className="font-font01 text-[29px]">Name</span>
          ...
          <div className="flex flex-col gap-[24px]">
            <label className="flex items-center justify-between">
              <span className="font-font01 text-[29px]">Phone Number</span>
              <span className="italic font-font03 text-[16px] text-orange00 ">
                Required*
              </span>
            </label>
      ...
      <div className="flex flex-col py-[64px] px-[24px] gap-[24px] bg-green01">
        <div className="font-font01 text-[29px] text-resin00 border-resin00 border-b-2 pb-[24px]">
          In your cart
        </div>
