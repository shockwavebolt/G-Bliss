    ...
    <div>
      ...
      <section className="flex flex-col items-center py-[24px] px-[16px] bg-resin00 text-green00 gap-[24px] md:px-[48px] xl:px-[96px] ">
        <div className="flex flex-col items-center gap-[48px]">
          <div className="font-font02 text-[76px]">Thank You!</div>
          <div className="font-font01 text-[18px]">
          ...
          <div className="flex flex-col gap-[24px]">
            <div className=" flex p-[48px] bg-resin01 justify-between">
              <div className="flex flex-col gap-[18px]">
                <div className="font-font01 text-[18px]">Order Detail</div>
                <div className="font-font03 text-[18px]">Order: #YA283</div>
                <div className="font-font03 text-[18px]">
                  Order Date: 05/14/25
                </div>
                <div className="font-font01 text-[18px]">
              ...
              <div className="flex flex-col gap-[18px]">
                <div className="font-font01 text-[18px]">Order Summary</div>
                <div className="font-font03 text-[18px]">
                  Pick-up in store: Free
                </div>
                <div className="font-font03 text-[18px]">Order-total</div>
              </div>
            </div>

            <div className="flex flex-col p-[32px] gap-[24px] bg-resin01">
              <div className="flex justify-between font-font01 text-[18px]">
                <div>219 Grove Street Brooklyn, NY 1123</div>
