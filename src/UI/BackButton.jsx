...
function BackButton() {
  ...
  return (
    <button
      className="group font-font01 flex cursor-pointer items-center gap-[4px]"
      onClick={() => navigate(-1)}
    >
      <span>
        <svg
        ...
        >
          <circle
            ...
            cy="24"
            r="23"
            className="stroke-resin00 group-hover:stroke-orange00 transition-colors duration-200"
            strokeWidth="2"
          />
          <path
            ...
            className="fill-resin00 group-hover:fill-orange00 transition-colors duration-200"
          />
        </svg>
      </span>
      <span className="transition-colors duration-200 group-hover:text-[#CF5C36]">
        Back
      </span>
    </button>
  );
