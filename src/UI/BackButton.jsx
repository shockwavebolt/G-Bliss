      ...
      <span>
        ...
        >
          <circle
            ...
            cy="24"
            r="23"
            className="transition-colors duration-200 stroke-resin00 group-hover:stroke-orange00"
            strokeWidth="2"
          />
          <path
            ...
            className="transition-colors duration-200 fill-resin00 group-hover:fill-orange00"
          />
        </svg>
      </span>
