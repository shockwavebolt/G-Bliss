      ...
      <span className="cursor-pointer">
        ...
        >
          <circle
            ...
            cy="24"
            r="23"
            className="stroke-[#465949] group-hover:stroke-[#CF5C36] transition-colors duration-200"
            strokeWidth="2"
          />
          <path
            ...
            className="fill-[#465949] group-hover:fill-[#CF5C36] transition-colors duration-200"
          />
        </svg>
      </span>
